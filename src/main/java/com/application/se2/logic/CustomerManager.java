...
import com.application.se2.misc.*;
 ...
 * CustomerManagerComp.LogicIntf with: - ComponentIntf.LogicIntf and -
...
public class CustomerManager implements CustomerManagerComp.LogicIntf {
  ...
  /**
   * Invoked on CustomerManager CRUDLogicIntf to fetch all matching Customer
   * objects from the repository for display on the GUI.
   * 
  ...
  /**
   * Find method that returns entity that matches the regular expression. If more
   * than one entity match, a random matching entity is returned.
   * 
   ...
   * 
   * @return newly created Customer instance (has Id, but is not saved to the
   *         repository, yet).
   */
  @Override
  ...
  /**
   * Invoked on CustomerManager CRUDLogicIntf to create a new instance of an
   * EntityProperty of a Customer instance.
   * 
   * @param property EntityProperty for which a new instance will be created.
   * @return newly created instance that has not yet been assigned to the Customer
   *         property.
   */
  @Override
  ...
  /**
   * Invoked on CustomerManager CRUDLogicIntf to process updates of a Customer
   * object.
   * 
   * @param updates EntityPropertyUpdateSet data structure to represent updated
   *                values.
   */
  @Override
    ...
    updates.iterateUpdatedProperties((p, s) -> {
      ...
      switch (propertyName) {
        ...
        case "contacts":
          ...
          // allow comma-separated contacts, e.g. "max@o2.de, 030-5697495" -> [0]
          // max@o2.de, [1] 030-5697495
  ...
  /**
   * Invoked on CustomerManager CRUDLogicIntf to delete a selection of Customer
   * entities.
   * 
  ...
  /**
   * Invoked on CustomerManager CRUDLogicIntf that is delegated to App-instance
