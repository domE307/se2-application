...
class SimpleRepositoryImpl<E extends Entity> implements RepositoryIntf<E> {
    ...
    private static final Logger logger = Logger.getInstance(SimpleRepositoryImpl.class);
    ...
    public E save(E entity) {
        ...
        logger.info( "Create new " + entity.getClass().getSimpleName() + ": " + entity.getId() );
        return e2;
    }
    ...
    public void deleteAllById(Iterable<String> ids) {
        for (String id : ids) {
            ...
            if (entity != null) {
                list.remove(entity);
                logger.info( "Delete " + entity.getClass().getSimpleName() + ": " + entity.getId() );
            }
        }
    }
